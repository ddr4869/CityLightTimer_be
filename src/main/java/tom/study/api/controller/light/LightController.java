...
public class LightController {
    ...
    @GetMapping("/light")
    public List<LightFeignMetaResponse> getLightTimingFeign(LightRequest lightRequest) {
        List<LightFeignMetaResponse> response = readLightUsecase.execute(lightRequest);
        return response;
    }
}
