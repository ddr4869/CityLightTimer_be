...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = -1160621865L;

    public static final QUser user = new QUser("user");

    public final EnumPath<User.EncryptionAlgorithm> algorithm = createEnum("algorithm", User.EncryptionAlgorithm.class);
